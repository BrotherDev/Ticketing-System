        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $tickets->where('user_id', auth()->id())->count() }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $tickets->where('status', 'closed')->where('user_id', auth()->id())->count() }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $tickets->where('status', 'in_progress')->where('user_id', auth()->id())->count() }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $tickets->where('status', 'open')->where('user_id', auth()->id())->count() }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            @foreach(['open' => 'NEW TICKET', 'in_progress' => 'WORKING ON IT', 'solved' => 'SOLVED', 'closed' => 'CLOSED'] as $status => $title)
                <div class="bg-white p-4 rounded shadow">
                    ...
                    @php
                        $filteredTickets = $tickets->where('status', $status)->where('user_id', auth()->id());
    ...
    @section('js')
        ...
        <script>
            ...
            $("#example1").DataTable({
                ...
                "order": [[3, 'dsce']], // Order by status column (index 3) ascending
                "buttons": ["colvis"]
